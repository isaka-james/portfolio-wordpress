 ...
 * Heading control
 */
class CWW_Portfolio_Heading extends WP_Customize_Control {
	 ...
	 * @var string
	 */
	public $type = 'cww-portfolio-customizer-heading';
	...
	protected function content_template() {
		...
		<h4 class="add-customizer-heading">{{{ data.label }}}{{{expandButton}}}</h4>
		{{{data.style}}}
		<?php
	}
